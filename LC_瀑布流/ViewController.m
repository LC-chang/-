...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[LCItemCell class] forCellWithReuseIdentifier:@"item"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    LCItemCell *cell = (LCItemCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"item"
                                                                           forIndexPath:indexPath];
    
    LCItemModel *model = [self.dataArray objectAtIndex:indexPath.row];
...
- (void)initData {
    ...
    for (NSString *item in imageArray) {
        LCItemModel *model = [LCItemModel new];
        model.imageUrl = item;
